...
export const places: Place[] = [
  {
    ...
    description:
      "하노이 호안끼엠 지역에서 이용할 수 있는 마사지 업소 정보입니다. 가격, 위치, 영업시간 등의 정보를 확인하고 방문 전 비용과 서비스를 미리 비교해보세요.",
...

  {
    ...
    description:
      "하노이 미딩 지역에서 이용할 수 있는 마사지 업소 정보입니다. 실제 운영 정보와 가격을 확인하고 방문 전 서비스 내용을 비교할 수 있습니다.",
...

  {
    ...
    description:
      "하노이 미딩·딘톤 지역에 위치한 강남스파 마사지 정보입니다. 강남스파 위치, 영업시간, 마사지 코스와 가격, 내부 시설 등 실제 방문에 필요한 정보를 확인할 수 있습니다. 방문 전 가격과 서비스 내용을 확인하여 불필요한 추가 비용이나 눈탱이를 예방하는 데 도움을 드립니다.",
...

  {
    ...
    description:
      "하노이 호안끼엠 지역의 가라오케 정보입니다. 가격, 룸 정보, 영업시간 등의 정보를 확인하고 방문 전 조건을 비교할 수 있습니다.",
...

  {
    ...
    description:
      "하노이 미딩 지역의 가라오케 정보입니다. 실제 업소 정보와 가격, 영업시간 등을 확인하고 방문 전 조건을 비교할 수 있습니다.",
