    ...
    <main className="min-h-screen overflow-x-hidden bg-[#08080a] text-white">
        ...
        <div className="absolute bottom-0 left-0 right-0">
          <div className="mx-auto max-w-7xl px-5 pb-10 md:px-8 md:pb-14">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-7 text-zinc-300 sm:text-base">
              ...
              강남스파(GANGNAM SPA) 이용정보입니다. 매장 위치와 시설 사진,
              마사지 코스와 가격, 영업시간 및 방문 전 확인사항을 한곳에서
              확인하세요.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 md:px-8 md:py-16">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-500">
          하노이 강남스파의 외관부터 리셉션, 마사지룸과 휴게공간까지
          실제 매장 사진을 확인해보세요.
        </p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 md:px-8 md:py-16">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-zinc-500">
            제공된 강남스파 가격표를 기준으로 정리한 코스별 이용시간과
            가격입니다. 가격 및 코스 구성은 변경될 수 있으므로 방문 전
            최신 내용을 확인하세요.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          ...
          <div className="rounded-3xl border border-cyan-400/30 bg-[#111114] p-7">
            ...
            <h3 className="mt-3 text-2xl font-black">A코스</h3>

            <p className="mt-2 text-sm text-zinc-500">30분</p>

            <div className="mt-7 border-t border-white/10 pt-6">
              <p className="text-xs text-zinc-500">이용시간</p>

              <p className="mt-2 text-lg font-black">30분</p>

              <p className="mt-6 text-xs text-zinc-500">가격</p>

              <p className="mt-2 text-3xl font-black text-cyan-300">
                1,400,000
                <span className="ml-1 text-base">VND</span>
              </p>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-amber-400/40 bg-[#111114] p-7">
            ...
            <h3 className="mt-3 text-2xl font-black">B코스</h3>

            <p className="mt-2 text-sm text-zinc-500">60분</p>

            <div className="mt-7 border-t border-white/10 pt-6">
              <p className="text-xs text-zinc-500">이용시간</p>

              <p className="mt-2 text-lg font-black">60분</p>
          ...
          <div className="rounded-3xl border border-fuchsia-400/30 bg-[#111114] p-7">
            ...
            <h3 className="mt-3 text-2xl font-black">C코스</h3>

            <p className="mt-2 text-sm text-zinc-500">90분</p>

            <div className="mt-7 border-t border-white/10 pt-6">
              <p className="text-xs text-zinc-500">이용시간</p>

              <p className="mt-2 text-lg font-black">90분</p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 md:px-8">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            <p className="text-xs text-zinc-500">업종</p>
            <p className="mt-2 font-black">마사지 · 스파</p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            <p className="text-xs text-zinc-500">지역</p>
            <p className="mt-2 font-black">하노이 미딩 · 딘톤</p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            <p className="text-xs text-zinc-500">영업시간</p>
            <p className="mt-2 font-black">12:00 - 01:00</p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            <p className="text-xs text-zinc-500">상호명</p>
            <p className="mt-2 font-black">GANGNAM SPA</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 md:px-8 md:py-16">
        ...
        <div className="mt-8 max-w-4xl space-y-6 text-[15px] leading-8 text-zinc-400">
          <p>
            하노이 강남스파(GANGNAM SPA)는 하노이 미딩 지역 딘톤에 위치한
            마사지 및 스파 시설입니다.
          </p>

          <p>
            미딩 한인타운 인근에서 하노이 마사지나 스파를 찾는 여행객과
            출장객들이 위치를 확인하기 편리한 지역에 있습니다.
          </p>

          <p>
            매장에는 리셉션과 마사지룸, 휴게공간 및 스낵바 등의 시설이
            있으며 제공된 실제 매장 사진을 통해 내부 분위기를 확인할 수
            있습니다.
          </p>

          <p>
            마사지 코스는 A, B, C 코스로 구분되어 있으며 이용시간에 따라
            가격이 달라집니다. 방문 전 원하는 코스와 가격을 다시 확인하는
            것을 권장합니다.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 md:px-8">
        <div className="rounded-3xl border border-white/10 bg-[#111114] p-7 md:p-10">
          ...
          <p className="mt-6 max-w-3xl text-sm leading-8 text-zinc-400">
            ...
            차량 호출 서비스를 이용할 경우 아래 주소를 입력하여 목적지를
            확인하는 것이 좋습니다.
          </p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 md:px-8">
        <div className="grid gap-5 md:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-[#111114] p-7 md:p-10">
            ...
            <p className="mt-8 text-4xl font-black">12:00 - 01:00</p>

            <p className="mt-5 text-sm leading-7 text-zinc-500">
              매장 운영시간은 변경될 수 있으므로 방문 당일 최신 정보를
              확인하는 것을 권장합니다.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-[#111114] p-7 md:p-10">
            ...
            <p className="mt-8 text-2xl font-black">방문 전 문의 권장</p>

            <p className="mt-5 text-sm leading-7 text-zinc-500">
              저녁시간이나 방문객이 많은 시간대에는 원하는 시간에 이용할 수
              있도록 방문 전에 예약 가능 여부를 확인하는 것이 좋습니다.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 md:px-8 md:py-16">
        ...
        <div className="mt-8 grid gap-5 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-[#111114] p-7">
            ...
            <h3 className="mt-4 text-xl font-black">리셉션</h3>

            <p className="mt-3 text-sm leading-7 text-zinc-500">
              매장 입구와 리셉션 공간을 실제 사진으로 확인할 수 있습니다.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-[#111114] p-7">
            ...
            <h3 className="mt-4 text-xl font-black">마사지룸</h3>

            <p className="mt-3 text-sm leading-7 text-zinc-500">
              마사지 이용공간의 내부 모습을 제공된 사진을 통해 확인할 수
              있습니다.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-[#111114] p-7">
            ...
            <p className="mt-3 text-sm leading-7 text-zinc-500">
              스낵바와 휴게공간도 준비되어 있으며 제공된 시설 사진에서
              확인할 수 있습니다.
            </p>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 md:px-8">
        <div className="rounded-3xl border border-white/10 bg-[#111114] p-7 md:p-10">
          ...
          <div className="mt-8 space-y-5 text-sm leading-8 text-zinc-400">
            <p>
              하노이 미딩 지역에서 차량 호출 서비스를 이용하면 강남스파까지
              편리하게 이동할 수 있습니다.
            </p>

            <p>
              Grab 등의 지도 및 차량 호출 앱에서 매장 주소를 입력한 뒤
              목적지를 확인하는 것을 권장합니다.
            </p>

            <p>
              딘톤 지역은 미딩 한인타운과 가까워 주변 식당이나 숙소에서
              함께 이동하기 편리합니다.
            </p>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-12 md:px-8 md:py-16">
        ...
        <div className="mt-8 space-y-4">
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-500">
              하노이 미딩 지역 딘톤에 위치하고 있습니다. 주소는 18 Ng. 1
              Đ. Đình Thôn, Đình Thôn, Nam Từ Liêm, Hà Nội입니다.
            </p>
          </details>
          ...
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-500">
              현재 확인된 안내 기준 영업시간은 매일 12:00부터 다음날
              01:00까지입니다. 방문 전 당일 운영 여부를 확인하는 것을
              권장합니다.
            </p>
          </details>
          ...
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-500">
              제공된 가격표 기준으로 A코스 30분 1,400,000동, B코스 60분
              1,800,000동, C코스 90분 2,100,000동입니다. 가격은 변경될 수
              있으므로 방문 전 다시 확인하세요.
            </p>
          </details>
          ...
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-500">
              현재 제공된 가격표에는 A, B, C 세 가지 코스가 안내되어 있으며
              각각 30분, 60분, 90분으로 구성되어 있습니다.
            </p>
          </details>
          ...
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-500">
              미딩 한인타운 인근 딘톤 지역에 위치해 있어 Grab 등의 차량 호출
              서비스를 이용하면 편리하게 방문할 수 있습니다.
            </p>
          </details>
          ...
          <details className="rounded-2xl border border-white/10 bg-[#111114] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-zinc-500">
              방문객이 많은 시간대에는 원하는 시간에 이용하기 위해 방문
              전에 예약 가능 여부를 확인하는 것을 권장합니다.
            </p>
          </details>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-5 py-14 md:px-8 md:py-20">
        <div className="rounded-3xl border border-amber-400/20 bg-gradient-to-b from-amber-950/20 to-[#111114] p-8 text-center md:p-14">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-zinc-400">
            하노이 미딩 강남스파의 시설 사진, 마사지 코스와 가격, 위치 및
            이용정보를 확인해보세요.
          </p>
