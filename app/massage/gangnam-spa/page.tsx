...
export async function generateMetadata({
  ...
  const spa = getPlace(slug);

  if (!spa) {
    return {
      title: "하노이 마사지",
      description: "하노이 마사지 및 스파 정보를 확인하세요.",
    };
  }

  return {
    title: `${spa.name} | 하노이 마사지 · ${spa.district}`,
    description: `${spa.name}의 위치, 영업시간, 마사지 코스, 가격, 시설 및 방문 전 확인사항을 확인하세요.`,
    keywords: [
      spa.name,
      "하노이 불건마",
      "하노이 스파",
    ...
    alternates: {
      canonical: `/${spa.category}/${spa.slug}`,
    },
  };
}
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative container py-24 md:py-36">
          ...
          <p className="text-xs font-black tracking-[0.35em] text-red-400">
            HANOI · {spa.category.toUpperCase()}
          </p>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_320px]">
          ...
          <div>
            ...
            <div className="mt-6 space-y-6 text-[15px] leading-8 text-zinc-400">
              ...
              <p>
                {spa.district} 지역에서 {spa.name}을(를) 찾는 경우
      ...
      <section className="container pb-16 md:pb-24">
        ...
        <div className="max-w-4xl">
          ...
          <div className="mt-7 space-y-6 text-[15px] leading-8 text-zinc-400">
            ...
            <p>
              {spa.name}은(는) {spa.district} 지역의 불건마 및
              스파 정보를 찾는 여행객이 참고할 수 있도록
              위치와 운영시간, 시설 및 이용 정보를 정리한 페이지입니다.
            </p>

            <p>
              하노이 마사지 정보를 검색할 때에는 가격뿐만 아니라
              매장 위치, 영업시간, 코스, 포함사항과 추가 비용 등을
              함께 확인하는 것이 좋습니다.
            </p>

            <p>
              {spa.name} 방문을 계획하고 있다면 방문 당일 최신
