...
const galleryImages = [
  {
    src: "/하노이 어메이징 마사지 메인.webp",
    title: "어메이징 마사지 메인",
  },
  {
    src: "/하노이 어메이징 마사지 건물.webp",
    title: "어메이징 마사지 건물",
  },
  {
    src: "/하노이 어메이징 마사지 입구.webp",
    title: "어메이징 마사지 입구",
  },
  {
    src: "/하노이 어메이징 마사지 리셉션.webp",
    title: "어메이징 마사지 리셉션",
  },
  {
    src: "/하노이 어메이징 마사지 룸.webp",
    title: "어메이징 마사지 룸",
  },
  {
    src: "/하노이 어메이징 마사지 느낌.webp",
    title: "어메이징 마사지 내부",
  },
];
...
const faqItems = [
  {
    q: "어메이징 마사지는 어디에 있나요?",
    a: "하노이 미딩 한인타운 지역에 위치해 있습니다. 주소는 28 ngõ 39 Đình Thôn, Mỹ Đình 1, Từ Liêm, Hà Nội입니다.",
  },
  {
    q: "영업시간은 어떻게 되나요?",
    a: "기본 안내 기준으로 13:00부터 익일 00:30까지 운영됩니다. 방문 전 당일 운영 여부를 다시 확인하는 것을 권장합니다.",
  },
  {
    q: "한국어로 상담할 수 있나요?",
    a: "한인 운영 업소로 안내되어 있어 코스 안내와 예약 상담을 한국어로 진행하기 편한 곳입니다.",
  },
  {
    q: "어메이징 마사지는 어떤 분위기인가요?",
    a: "호텔식 프라이빗 룸을 중심으로 차분하고 정돈된 분위기의 마사지 공간으로 안내되어 있습니다.",
  },
  {
    q: "처음 방문해도 이용하기 어렵지 않나요?",
    a: "미딩 한인타운에 위치하고 있으며 한국어 상담이 가능해 처음 방문하는 분들도 비교적 편하게 이용할 수 있습니다.",
  },
];

export default function AmazingMassagePage() {
        ...
        <div className="mx-auto max-w-7xl px-5 py-10 md:px-8 md:py-14">
          ...
          <div className="mb-8">
            ...
            <p className="mt-6 max-w-3xl text-sm leading-8 text-zinc-400 md:text-base">
              하노이 미딩 한인타운에서 이용할 수 있는 어메이징 마사지
              안내입니다. 위치와 영업시간, 시설 및 이용 정보를 한눈에
              확인할 수 있도록 정리했습니다.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-20">
          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-7 space-y-5 text-sm leading-8 text-zinc-400 md:text-base">
              ...
              하노이 미딩 한인타운에서 깔끔하고 편안하게 이용할 마사지샵을 찾는다면<br />
어메이징 마사지를 추천할 만합니다.<br /><br />

어메이징 마사지의 가장 큰 특징은 정돈된 시설과 한국어로 편하게 이용할 수 있는 운영 방식입니다.<br />
호텔식 프라이빗 룸으로 구성되어 있어 다른 손님과 동선이 크게 겹치지 않고,<br />
각 룸이 독립적으로 닫히는 구조라 조용하고 편안하게 이용하기 좋습니다.<br />
샤워 공간 역시 룸 단위로 마련되어 있어 처음 방문하는 분들도 복잡하지 않게 이용할 수 있습니다.<br /><br />

코스는 A부터 E까지 알파벳으로 구분되어 있어 처음 방문해도 선택하기 어렵지 않습니다.<br />
대표적으로 많이 찾는 코스는 B(VIP)이며,<br />
누루 코스를 원하는 분들을 위한 별도의 선택지도 마련되어 있습니다.<br />
표기 가격에 누루와 팁이 포함되는 구조라 이용 후 추가 비용에 대한 부담을 줄일 수 있다는 점도 장점입니다.<br /><br />

또한 한인 운영으로 코스 안내부터 관리사 선택, 원하는 요청사항까지 한국어로 편하게 소통할 수 있습니다.<br />
베트남어가 익숙하지 않은 초행 방문객에게는 이러한 원활한 의사소통이 큰 장점으로 느껴질 수 있습니다.<br />
당일 출근부를 기준으로 관리사를 선택할 수 있어 원하는 스타일이 있다면 방문 전에 미리 문의해 두는 것도 좋습니다.<br /><br />

위치는 미딩 딘톤 한인타운 안쪽인 28 ngõ 39 Đình Thôn에 자리하고 있으며,<br />
한식당과 편의시설이 많은 미딩 중심에서 접근하기 편한 편입니다.<br />
깔끔한 프라이빗 룸과 한국어 소통, 정찰제 코스까지 중요하게 생각한다면<br />
어메이징 마사지는 미딩에서 처음 방문하기에도 부담이 적은 선택지입니다.
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-6 text-sm leading-8 text-zinc-400">
                어메이징 마사지는 하노이 미딩 한인타운 지역에
                위치해 있습니다. 주소는 28 ngõ 39 Đình Thôn,
                Mỹ Đình 1, Từ Liêm, Hà Nội입니다.
              </p>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="rounded-2xl border border-white/10 bg-[#111] p-5">
                  ...
                  <p className="mt-2 text-sm leading-7 text-zinc-500">
                    그랩 이용 시 주소를 정확하게 입력하고,
                    기사에게 목적지를 확인한 후 이동하는 것을 권장합니다.
                  </p>
