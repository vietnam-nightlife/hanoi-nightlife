...
function MoonMassagePage({ city }: { city: string }) {
  const moonImages = [
    {
  ...
  const nextImage = () => {
    ...
    setSelectedImage(
      selectedImage === moonImages.length - 1
        ? 0
        : selectedImage + 1
    );
  };
    ...
    <main className="min-h-screen bg-[#050505] text-white">
      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-7xl px-5 py-10 md:px-8 md:py-14">
          ...
          <div className="mb-8">
            ...
            <p className="mt-6 max-w-3xl text-sm leading-8 text-zinc-400 md:text-base">
              하노이 미딩 한인타운에서 이용할 수 있는
              문 마사지 & 98 SPA 안내입니다.
              위치와 시설, 이용시간, 코스 및 가격 정보를
          ...
          >
            <div className="aspect-[16/8] overflow-hidden">
              <img
                src={moonImages[0].src}
                alt={moonImages[0].title}
                className="h-full w-full object-cover brightness-110 transition duration-700 group-hover:scale-[1.02]"
              />
            </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-20">
        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
          ...
          {moonImages.slice(1).map((image, index) => {
        ...
        <div className="mx-auto max-w-5xl px-5 py-16 md:px-8 md:py-20">
          ...
          <div className="mt-10 overflow-hidden rounded-3xl border border-[#8c6a3d]/40 bg-gradient-to-b from-[#17130e] to-[#0c0c0c] shadow-2xl">
            ...
            <div className="px-6 py-9 md:px-10">
              ...
              <div className="rounded-2xl border border-[#8c6a3d]/30 bg-black/20 p-6">

                <div className="text-lg font-black text-[#e7c793]">
                  2:1 추가 옵션
                </div>
        ...
        <div className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-20">
          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-7 space-y-5 text-sm leading-8 text-zinc-400 md:text-base">
              ...
              <p>
                60분 마사지 코스와 90분 때밀이 코스를
                중심으로 구성되어 있으며,
                사우나와 목욕 시설을 함께 이용할 수 있는
                것이 특징입니다.
              </p>
          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="mt-6 rounded-2xl border border-white/10 bg-[#111] p-5">
                ...
                <div className="text-xs font-black tracking-[0.2em] text-zinc-600">
                  ADDRESS
                </div>

                <div className="mt-3 text-sm font-bold leading-7 text-zinc-200">
        ...
        <div className="mx-auto max-w-4xl px-5 py-16 md:px-8 md:py-20">
          ...
          <div className="mt-10 space-y-3">
            ...
            {[
              {
                q: "문 마사지는 어디에 있나요?",
                a: "하노이 미딩 한인타운 딘톤 지역에 위치한 마사지·스파 업소입니다.",
              },
              {
                q: "가격은 얼마인가요?",
                a: "60분 마사지 코스는 150만동, 90분 때밀이 코스는 200만동으로 안내되고 있습니다. 2:1 이용 시 별도 추가 금액이 있습니다.",
              },
              {
                q: "영업시간은 어떻게 되나요?",
                a: "현재 확인되는 안내 기준으로 12:00부터 01:00 전후까지 운영되는 것으로 안내되고 있습니다. 방문 전 확인을 권장합니다.",
              },
              {
                q: "시설은 어떤가요?",
                a: "프라이빗 룸과 사우나, 샤워 및 욕조 등의 시설을 이용할 수 있는 것으로 안내되고 있습니다.",
              },
              {
                q: "예약하고 방문하는 것이 좋은가요?",
                a: "원하는 시간과 코스를 편하게 이용하려면 방문 전에 예약 가능 여부와 운영 상황을 확인하는 것을 권장합니다.",
              },
            ].map((item) => (
      ...
      {selectedImage !== null && (
        ...
        >
          ...
          <button
            ...
            onClick={closeGallery}
            aria-label="닫기"
            className="absolute right-5 top-5 z-20 flex h-12 w-12 items-center justify-center rounded-full border border-white/20 bg-black/60 text-2xl text-white"
          >
            ×
          </button>
          ...
          <button
            ...
            onClick={previousImage}
            aria-label="이전 사진"
            className="absolute left-3 top-1/2 z-20 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-white/20 bg-black/60 text-3xl text-white md:left-8"
          >
            ‹
          </button>
          ...
          <div className="relative flex max-h-[90vh] max-w-[92vw] flex-col items-center">
            ...
            <img
              src={moonImages[selectedImage].src}
              alt={moonImages[selectedImage].title}
              className="max-h-[82vh] max-w-[92vw] rounded-xl object-contain brightness-110 shadow-2xl"
            />

            <div className="mt-4 text-center text-sm text-zinc-300">
              {moonImages[selectedImage].title}
            </div>

            <div className="mt-1 text-xs text-zinc-600">
              {selectedImage + 1} / {moonImages.length}
            </div>
          ...
          <button
            ...
            onClick={nextImage}
            aria-label="다음 사진"
            className="absolute right-3 top-1/2 z-20 flex h-12 w-12 -translate-y-1/2 items-center justify-center rounded-full border border-white/20 bg-black/60 text-3xl text-white md:right-8"
          >
            ›
          </button>
