...
const PROFILE_IMAGE = "/에코걸프로필.webp";
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="container relative py-16 sm:py-24">
          ...
          <h1 className="max-w-4xl text-5xl font-black leading-[1.05] tracking-tight sm:text-7xl">
            하노이
            <br />
            <span className="red">에코걸</span>
          </h1>

          <p className="mt-7 max-w-2xl text-base leading-8 text-zinc-400 sm:text-lg">
            하노이 에코걸 관련 프로필과 이용 정보를
      ...
      <section className="container py-14 sm:py-20">
        ...
        <div className="mb-8">
          ...
          <p className="mt-3 text-sm leading-7 text-zinc-500">
            프로필을 먼저 확인하신 후 아래 이용 정보를 확인해주세요.
          </p>
        </div>
        ...
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-[#0a0a0a]">
          ...
          <div className="grid lg:grid-cols-2">
            ...
            {/* 사진 */}
            <div className="relative min-h-[420px] overflow-hidden bg-black sm:min-h-[600px]">
            ...
            <div className="flex flex-col justify-center p-7 sm:p-10">
              ...
              <div className="mt-7">
                <Link
                  href="#contact"
                  className="inline-flex rounded-xl bg-red-600 px-6 py-3.5 text-sm font-black transition hover:bg-red-500"
                >
                  상담 문의하기 →
                </Link>
              </div>
        ...
        <div className="container py-16 sm:py-20">
          ...
          <div className="grid gap-4 md:grid-cols-5">
            ...
            <Step
              number="01"
              title="문의"
              text="카카오톡 또는 텔레그램으로 문의해주세요."
            />

            <Step
              number="02"
              title="일정 전달"
              text="원하는 날짜와 시간을 알려주세요."
            />
